...
namespace MobileAppsFileSampleService
{
    public static class WebApiConfig
    {
        public static void Register()
        {
            ...
            Database.SetInitializer(new fcxfquickstartInitializer());
        }
    }

    public class fcxfquickstartInitializer : ClearDatabaseSchemaIfModelChanges<MobileAppsFileSampleContext>
    {
